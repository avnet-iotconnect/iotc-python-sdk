...
from iotconnect.client.aws_mqttclient import mqttclient
...
class aws_IoTConnectSDK:
    ...
    def get_config(self):
        print("TRIAL(aws_Iotconnectsdk.py)::function: {}, Line : {}" .format(inspect.currentframe().f_code.co_name,inspect.currentframe().f_lineno))
        try:
            self._config = None
    ...
    def GetAttributes(self,callback):
        ...
        try:
            if callback:
                ...
                print("In self._getattribute_callback = callback")
            # self._hello_handsake({"mt":201,"sid":self._sId})    
            self._hello_handsake({"mt":201})
            print("In self._hello_handsake({\"mt\":201})")
        except Exception as ex:
